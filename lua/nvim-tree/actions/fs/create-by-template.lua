...
function M.template_exists(file)
  if utils.template_exists(M.template_dirm, file) then
...
local function create_file_by_template(file)
  M.template_exists(file)
  ...
  vim.ui.input(input_opts, function(new_file_path)
    ...
    for path in utils.path_split(new_file_path) do
      ...
      if is_last_path_file and idx == num_nodes then
        create_file_by_template(path_to_create)
...
function M.setup(opts)
  ...
  M.template_dir = opts.template_dir
end
